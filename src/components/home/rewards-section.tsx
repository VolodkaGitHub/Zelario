...
import DailyLoginModal from "@/components/home/daily-login-modal"
...
const rewards = [
    {
        ...
        description: `Earn ${REWARD_AMOUNT} ZEL points daily just for checking in.`,
...
export default function RewardsSection() {
    ...
    function handleCardClick(id: string) {
        if (id === "daily-login") setDailyLoginOpen(true)
    }
        ...
        <>
            <section ref={sectionRef} className="py-24 px-4 sm:px-6 lg:px-8 bg-black relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    ...
                    <div ref={cardsRef} className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                        {rewards.map((reward) => (
                            <Card
                                ...
                                className={`reward-card group bg-gray-900/50 backdrop-blur-sm border-gray-800 transition-all duration-300 hover:transform hover:-translate-y-2 hover:shadow-2xl ${reward.border} ${reward.clickable ? "cursor-pointer" : ""}`}
                            >
                                <CardContent className="p-6 h-full flex flex-col items-center text-center relative overflow-hidden">
                                    ...
                                    {reward.clickable && (
                                        <p className="relative z-10 text-purple-400 text-xs mt-3 font-medium">
                                            Click to claim →
                                        </p>
                                    )}
                                </CardContent>
                    ...
                    <div className="text-center reward-header">
                        <Button
                            size="lg"
